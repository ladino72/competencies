...
function Teacher() {
    ...
    return (
        ...
        <div className="container mx-auto w-full mt-20">
            <div className='font-bold uppercase text-center text-blue-600 text-3xl font-roboto'>Ingreso de notas </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                {typeOfCourse == "Laboratorio" && typeOfCourse != null ? <div className='flex flex-col  md:flex-row md:space-x-40 px-2'>
                    ...
                    <div className="basis-1/2 mt-1 z-50 ">
                ...
                {typeOfCourse == "Teoria" && typeOfCourse != null ?
                    <div className='flex flex-col  md:flex-row md:space-x-40 px-2'>
                        ...
                        <div className="basis-1/2 mt-1 z-40 ">
            ...
            {typeOfCourse != null && teocourse != "" && displayList == true || typeOfCourse != null && labcourse != "" && displayList == true ? <CourseGrades /> : null}
