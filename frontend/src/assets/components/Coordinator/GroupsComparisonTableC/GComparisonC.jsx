...
const GComparisonC = ({ data, loading }) => {
                                        ...
                                        <tbody>
                                            {competency.info.sort((a, b) => a._id.group.g_Id.localeCompare(b._id.group.g_Id)).map((info) => (
                                                ...
                                                <tr key={Math.random()}>
                                                    ...
                                                    <td className="border px-2 py-2 text-center w-min-full">{info.totalActivities}</td>
                                                    {/* When you apply whitespace-nowrap to an element, it ensures that all the content within the element stays on a single line, no matter how long the text is. */}
